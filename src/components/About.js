        ...
        return(
            <div className="body clearfix">
                ...
                <div className="human-timeline clearfix">
                    ...
                    <div className="timeline-item">
                        <h2 className="about-timeline-year" >2000</h2>
                    ...
                    <div className="timeline-item">
                        <h2 className="about-timeline-year">2012</h2>
                    ...
                    <div className="timeline-item">
                        <h2 className="about-timeline-year">2013</h2>
                    ...
                    <div className="timeline-item">
                        <h2 className="about-timeline-year">2014</h2>
                        <p>Started doing the agency thing.</p><p><a target="_blank" href ="https://www.youtube.com/watch?v=NSrVKVGBAcE">This</a> is my favorite advertisement.</p>
                    </div>
                    <div className="timeline-item">
                        <h2 className="about-timeline-year">2015</h2>
